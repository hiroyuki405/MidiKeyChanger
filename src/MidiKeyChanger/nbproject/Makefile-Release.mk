...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/midikeychanger.exe: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/midikeychanger ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/debugPrint.o: debugPrint.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/debugPrint.o debugPrint.cpp

${OBJECTDIR}/hardInterface.o: hardInterface.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/hardInterface.o hardInterface.cpp
...
${OBJECTDIR}/midiMng.o: midiMng.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/midiMng.o midiMng.cpp

${OBJECTDIR}/pinMonitor.o: pinMonitor.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/pinMonitor.o pinMonitor.cpp

${OBJECTDIR}/timerParameter.o: timerParameter.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/timerParameter.o timerParameter.cpp

${OBJECTDIR}/timerState.o: timerState.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/timerState.o timerState.cpp
